...
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Арсен', 'Акопджанян Арсен', '$2a$06$w2gv8Yk.uqi237Ptfq0EveghQv97alCL8Vx.i3RQkV3jV5wPyLaSC', 'ROLE_GUEST', 'akar', '1-42', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Мария', 'Акопджанян Мария', NULL, 'ROLE_GUEST', NULL, '1-42', NULL, 0, 0);
...
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Евгений', 'Бакулин Евгений', '$2a$06$ggqCOqqrb2SJbuhIAbJ5sO4EnKkVOMKWUuup5Dct31LvfnZOqz1C2', 'ROLE_GUEST', 'baev', '1-43', NULL, 0, 0);
...
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Денис', 'Валиев Денис', NULL, 'ROLE_GUEST', NULL, '1-27', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Ильфат', 'Валиев Ильфат', '$2a$06$b68s8OW04ta1DxvVUMaAqOqBaxk63nN0aLpgDg1YvEOp2LLMC94zi', 'ROLE_GUEST', 'vail', '1-27', NULL, 0, 0);
...
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Тимур', 'Валиев Тимур', NULL, 'ROLE_GUEST', NULL, '1-27', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Шамиль', 'Валиев Шамиль', '$2a$06$PdZbAOje7HzuPJxw5f8DZ.BiSXdBVSPyycgO8brLHNnK1f1BCPrjC', 'ROLE_GUEST', 'vash', '1-38', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Оксана', 'Валиева Оксана', NULL, 'ROLE_GUEST', NULL, '1-27', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Регина', 'Валиева Регина', NULL, 'ROLE_GUEST', NULL, '1-38', NULL, 0, 0);
...
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Валерия', 'Горленко Валерия', NULL, 'ROLE_GUEST', NULL, '1-20', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Яна', 'Горленко Яна', '$2a$06$.QkJ9z07ySiWLSxpiTx.KexLaRpNTIEVgN.8QQ2IzQfhTIgoHGDP.', 'ROLE_GUEST', 'goya', '1-20', NULL, 0, 0);
...
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Николай', 'Золотов Николай', '$2a$06$bq4C/uf2PrVuVTJDIyUGSeMjCRdxh5VtWsZkQ6cbGsZOGGz6wy5ia', 'ROLE_GUEST', 'goni', '1-21', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Анастасия', 'Золотова Анастасия', NULL, 'ROLE_GUEST', NULL, '1-21', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Марина', 'Золотова Марина', NULL, 'ROLE_GUEST', NULL, '1-21', NULL, 0, 0);
...
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Владимир', 'Иванов Владимир', '$2a$06$xTbt6l1zil89Xu7Q.8z83uHNvLYANH2ITgLpB1jl9TVXvxx5zh15m', 'ROLE_GUEST', 'ivvl', '1-26', '', 0, 0);
...
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Руслан', 'Иванов Руслан', NULL, 'ROLE_GUEST', NULL, '1-26', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Юрий', 'Иванов Юрий', '$2a$06$gPLRSHYAXVkpk5PSFV2dtufHY/aXEPHJL2abkf.yxaqxnVxZcIWVC', 'ROLE_GUEST', 'ivur', '1-29', NULL, 0, 0);
...
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Елена', 'Иванова Елена', NULL, 'ROLE_GUEST', NULL, '1-26', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Елена', 'Иванова Елена', NULL, 'ROLE_GUEST', NULL, '1-29', NULL, 0, 0);
...
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Олег', 'Каношин Олег', '$2a$06$B8o0nv6iLRbZh0FsKQrpaOQp3ei/fXWPOLEidNfaQ8B/e7x0sfWFu', 'ROLE_GUEST', 'kaol', '2-5', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Анастасия', 'Каношина Анастасия', NULL, 'ROLE_GUEST', NULL, '2-5', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Виктория', 'Каношина Виктория', NULL, 'ROLE_GUEST', NULL, '2-5', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Ирина', 'Каношина Ирина', NULL, 'ROLE_GUEST', NULL, '2-5', NULL, 0, 0);
...
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Сергей', 'Кудряшов Сергей', '$2a$06$Qgu6.Hr3HjodjUKNZFsoR..roXEZMreKrloaRfSZ.qez4v2VZ5Q/K', 'ROLE_GUEST', 'kuse', '1-25', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Александра', 'Кудряшова Александра', NULL, 'ROLE_GUEST', NULL, '1-25', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Андрей', 'Лобастов Андрей', '$2a$06$2KJH0./KB44QHFOp12I0jeP4N5tob8v39GVmo71E4izIsbtpsQf/e', 'ROLE_GUEST', 'loan', '1-39', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Роман', 'Мажанов Роман', '', 'ROLE_GUEST', '', '1-6', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Юлия', 'Мажанова Юлия', '', 'ROLE_GUEST', '', '1-6', NULL, 0, 0);
...
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Евгений', 'Патлусов Евгений', '$2a$06$RztnUBAPwXGt55D5SxogoezZx07hnmnoCzxvUGKdyqhL0/VmaP34q', 'ROLE_GUEST', 'paev', '2-4', NULL, 0, 0);
...
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Рамиля', 'Рамиля Лобастова', NULL, 'ROLE_GUEST', NULL, '1-39', NULL, 0, 0);
...
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Мария', 'Точеная Мария', '$2a$06$C48xNqv/pVrAchO1N9ti7ukxRf4wI6YAXX/YAjeaDJuMxNRkDyD76', 'ROLE_GUEST', 'toma', '2-7', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Анатолий', 'Тремазов Анатолий', '$2a$06$XKM6ykHpGOD8pBCKsZWp1.hfhzsl65GSfTcDQMEgMZyvt92PPRsEu', 'ROLE_GUEST', 'tran', '2-12', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Вероника', 'Тремазова Вероника', NULL, 'ROLE_GUEST', NULL, '2-12', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Татьяна', 'Тремазова Татьяна', NULL, 'ROLE_GUEST', NULL, '2-12', NULL, 0, 0);
...
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Артур', 'Хазиев Артур', NULL, 'ROLE_GUEST', NULL, '2-3', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Даниил', 'Хазиев Даниил', NULL, 'ROLE_GUEST', NULL, '2-3', NULL, 0, 0);
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Марина', 'Хазиева Марина', '$2a$06$TopFuCkD2KMXbehqAQQpDe5FxSINQiYpTD4oIvPt3zdQIR0n12fqS', 'ROLE_GUEST', 'hama', '2-3', NULL, 0, 0);
...
INSERT INTO `guest` (  `name`, `fio`, `password`, `role`, `login`, `family`, `email`, `goToWedding`, `needHome`) VALUES ( 'Евгений', 'Чаплагин Евгений Александрович', '$2a$06$48lhi5YjDHY/spfObTCxVendlHqBiXX5uYBikJtz6vzazR5EQACCe', 'ROLE_GUEST', 'chev', '1-2', 'qweq', 0, 0);
